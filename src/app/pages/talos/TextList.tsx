                ...
                <div className="group relative inline-flex items-center">
                  ...
                  {place.description.falc.status.isCertified ? (
                    ...
                    <button
                      ...
                      className="duration-5 mb-2 ml-4 flex items-center gap-4 rounded-xl border-2 border-[#0A184D] bg-[#bfdcfe] px-6 py-2 text-xl text-[#0A184D] transition-all hover:border-2 hover:border-[#0A184D] hover:bg-[#F4FDFF] hover:text-[#0A184D]"
                      aria-label={`Corriger ${String(place.name.fr)}`}>
                      <PencilIcon />
                      <p>Corriger</p>
                    </button>
                  )}
