...
const FormClient: FC = () => {
  ...
  return (
    <>
      {/*CONTAINER */}
      <div className="grid grid-cols-1 gap-1 p-7 sm:grid-cols-1">
        {/*SELECTION AREA */}
        ...
        <div className="border-stroke shadow-defaul dark:border-strokedark dark:bg-boxdark dark:border-strokedark dark:bg-boxdark flex flex-row rounded-sm border bg-white p-5">
          {/*INPUT AREA 1*/}
          {!message.info ? (
            <form
              onSubmit={() => handleSubmit}
              className="border-stroke shadow-defaul dark:border-strokedark dark:bg-boxdark mt-5 flex w-1/2 flex-col rounded-sm border p-2">
                    ...
                    return (
                      <div className="mt-5 flex flex-col">
                        ...
                        <textarea
                          ...
                          id={id}
                          name={name}
                          className="border-stroke focus:border-primary active:border-primary disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary w-2/3 rounded border-[1.5px] bg-transparent px-5 py-3 text-black outline-none transition disabled:cursor-default dark:text-white"
            ...
            <>
              <div className="border-stroke shadow-defaul dark:border-strokedark dark:bg-boxdark mt-5 flex w-1/2 flex-col items-center rounded-sm border p-2">
                <h1> ✅ {message.info}</h1>
                <img width="30%" src={successImage} alt="Success Minos" />
              </div>
            </>
          )}
          <div className="border-stroke shadow-defaul dark:border-strokedark dark:bg-boxdark mt-5 w-1/2 rounded-sm border bg-yellow-300 p-2">
