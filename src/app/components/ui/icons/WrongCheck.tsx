...
export const WrongCheck = ({ ...props }: SvgProps) => {
  return (
    <>
      <svg
        ...
        <g id="Calque_2" data-name="Calque 2">
          <g id="Calque_1-2" data-name="Calque 1">
            <path
              ...
              fill="#ff5e5a;stroke:#0a184d;stroke-miterlimit:10;stroke-width:14px"
            />
            <path
              ...
              fill="#0a184d;stroke:#0a184d;stroke-miterlimit:10;stroke-width:10px"
            />
          </g>
        </g>
      </svg>
