...
const TalosInterfaceMain = ({ formData }: TalosInterfaceMainProps) => {
    ...
    const handleChangeText = (index: number, e: React.ChangeEvent<HTMLTextAreaElement>) => {
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="ml-8 flex flex-grow">
                        <div
                            ...
                            }>
                            {
                                ...
                                <>
                                    <div className="mt-4 h-auto rounded-md border-2 border-black bg-white p-6 shadow-2xl">
                                        <h2 className="mb-4 text-2xl font-bold text-[#0a184d]">Je relis :</h2>
                                        {
                                            <div className="space-y-4">{
                                                falcText.map((sentence: string, index: number) => {
                                                    return <div key={index}><p className="text-sky-950 text-xl">{sentence}</p></div>
                                                })}
                                            </div>
                                        }
                            ...
                            {
                                !showProofReading && <MainContent formData={formData} sentencesData={sentencesData} />
                            }
                        </div>
