...
const ButtonWithIcon: React.FC<ButtonWithIconProps> = ({
  ...
  return (
    <button
      className="flex h-48 w-32 flex-col items-center justify-center rounded-lg border-2 border-red-400 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-700"
      //onClick={}
    >
